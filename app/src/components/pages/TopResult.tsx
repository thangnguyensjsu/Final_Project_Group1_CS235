...
function TopResult({picture, name, rating, price, distance}: any){
    return (
        <div>
            <span className="font-semibold pl-6">Top Pick For You</span>
            <div className="pl-6 pb-8 pt-8 border-solid border-2 border-green-500 bg-green-100 m-4 rounded-3xl relative ">
                ...
                <div className="grid grid-cols-2 absolute md:right-4 right-2 top-6">
                    ...
                    <button className="bg-green-800 active:bg-green-900 text-white font-semibold py-2 mb-2 mt-6 md:mx-3 mx-5 drop-shadow-md rounded-3xl">
                        <a href="/menu">
                            Order
                        </a>
                    </button>
